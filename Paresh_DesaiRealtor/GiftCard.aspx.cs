...
namespace Property
{
    public partial class GiftCard : System.Web.UI.Page
    {
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               // clsp.Insert_CommBuyingSelling(txtName.Text, txtEmail.Text, txtPhoneno.Text, Convert.ToString(ddlPriceRange.SelectedValue), Convert.ToString(ddlCity.SelectedValue));
                ...
                txtEmail.Text = "";
                txtRent.Text = "";
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Thanks!", "alert('Your E-mail has been sent sucessfully.');", true);
                return;
        ...
        public void SendMailToAdmin(string UserEmailId)
        {
            ...
            string ToEmailID = ConfigurationManager.AppSettings["RegFromMailAddress"].ToString(); //From Email & To Email are same for admin
            ...
            mail.Subject = "Preet Hothi & Bobby Jassal Property";
            string body = "";
            body = "<p>Person Name : " + txtName.Text + " "+txtLastName.Text+ "</p>";
            body = body + "<p>Email ID : " + UserEmailId + "</p>";
            body = body + "<p>Phone Number : " + txtPhoneno.Text+ "</p>";
            body = body + "<p>Rent or own property : " + txtRent.Text + "</p>";
            mail.Body = body;
