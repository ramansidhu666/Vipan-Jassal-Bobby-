...
<script>
    ...
    $(document).ready(function () {
        $("#shareBtn").click(function () {
            ...
            var URL = 'http://homegreathome.ca/PropertyDetails.aspx?MLSID=' + MLSID + '&PropertyType=' + PropertyType;
